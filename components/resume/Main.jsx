      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <div class="row">
            <div class="col-12">
              ...
              <p>React, JavaScript, HTML, SCSS, Bootstrap, Git, Node.js, PHP</p>
            </div>
          </div>
          <div class="row">
            <div class="col-12">
        ...
        <div class="col-md-8">
          <div class="row">
            <div class="col-12">
              ...
              <ul class="list-group list-group-flush">
                <li class="list-group-item">
                  Translation of designer mock-ups and wireframes into front-end
                  code
                </li>
                <li class="list-group-item">
                ...
                <li class="list-group-item">
                  Maintaining standard code style with shareable configs within
                  the project to improve the efficiency and code readability
                  across team.
                </li>
                <li class="list-group-item">
                  Wrote support documentation and provided training to the team
                  internally.
                </li>
                <li class="list-group-item">
            ...
            <div class="col-12">
              ...
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                  Coordinated with team of UX designers to create new Web Portal
          ...
          <div class="row">
            <div class="col-12">
              <h3>Education</h3>
              <h4>ICAT Design & Media College</h4>
              <p>P.G Diploma in Game Development (2014)</p>
            </div>
            <div class="col-12">
              <h4>Vel Tech Dr.RR & Dr.SR Technical University</h4>
              <p>Bachelor of Technology in Mechanical Engineering (2013)</p>
            </div>
          </div>
        </div>
      </div>
